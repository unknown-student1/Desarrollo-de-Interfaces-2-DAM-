...
{
    public partial class FormTransaccionAdd : Form
    {
        // Obtener la cadena de conexión
        private string cadenaConexion = Conexion.ObtenerCadena;
        

        public FormTransaccionAdd(string codigoCliente)
        {
            InitializeComponent();
            ...
            // Cargar por defecto el cliente seleccionado
            cbxClientes.SelectedValue = Convert.ToInt32(codigoCliente);
